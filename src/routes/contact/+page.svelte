...
<div class="container mx-auto px-4 max-w-4xl md:pb-10">
  ...
  <section class="md:mb-20 pt-12 md:pt-20">
    ...
    <p class="mb-4">
      Connect with artists, collectors, and blockchain experts by joining the ARC Discord server. Engage in discussions, ask questions, and stay up to date with the latest developments in art provenance and digital certification.
    </p>
