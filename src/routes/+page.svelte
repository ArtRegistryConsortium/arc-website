...
<div class="container mx-auto px-4">
  ...
  <section class="py-10 md:py-16 border-t border-muted">
    <div class="py-6 md:py-10">
      ...
      <div class="space-y-3 md:space-y-4 max-w-3xl mx-auto px-2">
        ...
        <p class="text-center max-w-3xl mx-auto">
          <span class="font-semibold">Artist-Owned Contracts</span> - Each artist deploys their own contract, maintaining full control.
        </p>
        <p class="text-center max-w-3xl mx-auto">
          <span class="font-semibold">Evolving Documentation</span> - Update exhibition history, bibliographies, and ownership over time.
        </p>
        <p class="text-center max-w-3xl mx-auto">
          <span class="font-semibold">Gallery & Collector Tools</span> - Verify authenticity and track provenance with ease.
        </p>
      </div>
    </div>
  ...
  <section class="py-12 md:py-20 border-t border-muted">
    <div class="py-6 md:py-10">
      ...
      <p class="text-center max-w-3xl mx-auto">
        <span class="font-semibold">3. Evolve & Verify</span> - Update documentation, verify authenticity, and track provenance.
      </p>
    </div>
  </section>
  ...
  <section class="py-12 md:py-20 border-t border-muted">
    <div class="py-6 md:py-10">
      ...
      <p class="text-center max-w-3xl mx-auto">
        <span class="font-semibold">Galleries</span> - Authenticate and support artists' work.
      </p>
      <p class="text-center max-w-3xl mx-auto">
        <span class="font-semibold">Collectors</span> - Verify ownership and provenance.
      </p>
      <p class="text-center max-w-3xl mx-auto">
        <span class="font-semibold">Institutions</span> - Preserve art records for future generations.
      </p>
    </div>
  </section>
